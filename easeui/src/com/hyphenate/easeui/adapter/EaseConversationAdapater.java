...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            try {
                Glide.with(getContext()).load(conversation.getLastMessage().getStringAttribute("groupUrl")).diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.ease_group_icon).into(holder.avatar);
            } catch (Exception e){
                Log.e("EaseUi error", "no groupUrl has send");
            }
