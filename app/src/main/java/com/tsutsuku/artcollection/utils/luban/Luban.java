package com.tsutsuku.artcollection.utils.luban;
...
import static com.tsutsuku.artcollection.utils.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private static File createCacheDir(String cacheDir) {
        if (cacheDir.isEmpty()){
            return null;
        }
    ...
    public static Luban get(Context context, String cacheDir) {
        if (INSTANCE == null) INSTANCE = new Luban(createCacheDir(cacheDir));
        return INSTANCE;
    }
    ...
    public static void clearCache(Context context) {
        File file = getPhotoCacheDir(context);
    ...
    private File thirdCompress(@NonNull File file) {
        String thumb = mCacheDir.getAbsolutePath() + File.separator +
                (TextUtils.isEmpty(filename) ? System.nanoTime() : filename) + ".jpg";
