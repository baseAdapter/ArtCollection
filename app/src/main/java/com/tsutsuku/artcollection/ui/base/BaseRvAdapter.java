...
import com.tsutsuku.artcollection.contract.base.IAdapter;
import com.tsutsuku.artcollection.ui.adapter.ItemTypeUtil;
...
public abstract class BaseRvAdapter<T> extends BaseAdapter<BaseRvAdapter.RvAdapterItem> implements IAdapter<T> {
    ...
    public boolean isLimit() {
        return loading || mDataList.size() >= total - offset;
    }
