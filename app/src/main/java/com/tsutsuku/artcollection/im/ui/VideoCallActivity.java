                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            if(error == CallError.ERROR_NO_DATA){
                                netwrokStatusVeiw.setText(R.string.em_no_call_data);
                            }else{
                                netwrokStatusVeiw.setText(R.string.em_network_unstable);
                            }
                        }
                    });
                    break;
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (fError == CallError.REJECTED) {
                                ...
                                callStateTextView.setText(R.string.em_call_version_inconsistent);
                            }  else {
                                if (isAnswered) {
                                    callingState = CallingState.NORMAL;
    ...
    public void onClick(View v) {
        ...
        case R.id.btn_record_video: //record the video
            if(!isRecording){
                ...
                isRecording = true;
                recordBtn.setText(R.string.em_stop_record);
            }else{
                String filepath = callHelper.stopVideoRecord();
                isRecording = false;
                recordBtn.setText(R.string.recording_video);
                Toast.makeText(getApplicationContext(), String.format(getString(R.string.em_record_finish_toast), filepath), Toast.LENGTH_LONG).show();
            }
            break;
